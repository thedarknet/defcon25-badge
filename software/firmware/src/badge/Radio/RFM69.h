...
#else 
  #define RF69_IRQ_PIN          GPIO_PIN_0
  #define RF69_IRQ_NUM          0  
#endif
...
class RFM69 {
  public:
    ...
    RFM69(uint8_t slaveSelectPin=15, uint8_t interruptPin=RF69_IRQ_PIN, bool isRFM69HW=false, uint8_t interruptNum=RF69_IRQ_NUM);
